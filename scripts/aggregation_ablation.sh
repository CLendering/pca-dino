...
# -------------------------------
# Run all aggregation configurations
# -------------------------------
for KEY in "${!LAYERS_LIST[@]}"; do
    ...
    #     --k_shot 4 \
    #     --aug_count 30 \
    #     --outdir "FINALresults_ablation/mvtec_${KEY}_res${RES}_ev${PCA_EV}"
    ...
    conda run -n pcadino python -u main.py \
        ...
        --k_shot 4 \
        --aug_count 30 \
        --outdir "FINALresults_ablation/visa_${KEY}_res${RES}_ev${PCA_EV}"
done
