...
# -----------------------------------------------------------------
# --- 2. DEFINE MODELS AND LAYER STRATEGIES ---
# -----------------------------------------------------------------
...
# --- 3. RUN EXPERIMENTS ---
# Iterate over all defined backbones
for i in ${!BACKBONES[@]}; do
    ...
    do
        ...
        conda run -n pcadino python -u main.py \
            ...
            --pca_ev 0.99 \
            --agg_method "mean" \
            --outdir "FINALresults_ablations/results_k${k}_mvtec_${MODEL_NAME}" \
            --save_intro_overlays
    done
    ...
    #         --pca_ev 0.99 \
    #         --agg_method "mean" \
    #         --outdir "FINALresults_ablations/results_k${k}_visa_${MODEL_NAME}" \
    #         --save_intro_overlays 
    # done
